...
sous-titre: "Des eaux turquoises aux fermes d'épices, profitez de chauffeurs ponctuels, véhicules confortables et expériences authentiques. Réservez en un clic sur WhatsApp.",
...
p2: "Transferts fiables, excursions authentiques, rencontres locales: nous privilèges l'expérience, l'équité et le respect des communautés, pour un Zanzibar vrai et mémorable.",
légende: "Votre hôte à Zanzibar",
cta: "Contacter sur WhatsApp"
},
services: {
title: "Nos services",
carte1 : {
titre : "Transferts & Taxi privé",
texte : "Aéroport ↔ Hôtel et trajets sur mesure. Chauffeurs professionnels, prix clairs.",
chip: "Disponible 24/7"
},
card2: {
title: "Excursions",
texte: "Safari Blue, Prison Island, Stone Town, dhow au coucher du soleil et plus encore."
},
card3: {
title: "Spice Tour",
text: "Visitez les fermes d'épices, dégustez et découvrez l'héritage swahili." title: "Laisser un avis",
}
},
booking: {
...
soumettre : "Envoyer l'avis"
}
},
pied de page : {
emplacement : "Zanzibar, Tanzanie"
},
wa : {
bienvenue : "Bonjour MVITA Travels !",
message : { en-tête : "Bonjour MVITA Travels !" }
}
},
...
en: {
  ...
  services: {
    title: "Our services",
    card1: {
      title: "Transfers & Private Taxi",
      text: "Airport ↔ Hotel and custom rides. Professional drivers, transparent prices.",
      chip: "Available 24/7"
    },
    card2: {
      title: "Excursions",
      text: "Safari Blue, Prison Island, Stone Town, sunset dhow and more."
    },
    card3: {
      title: "Spice Tour",
      text: "Visit spice farms, taste and discover Swahili heritage."
    }
  },
  booking: {
    title: "Quick booking",
  ...
  wa: {
    welcome: "Hello MVITA Travels!",
    message: { header: "Hello MVITA Travels!" }
  }
},
...
es: {
  ...
  services: {
    ...
    card1: {
      title: "Traslados y Taxi privado",
      text: "Aeropuerto ↔ Hotel y trayectos a medida. Conductores profesionales, precios transparentes.",
      chip: "Disponible 24/7"
    },
    card2: {
      title: "Excursiones",
      text: "Safari Blue, Prison Island, Stone Town, dhow al atardecer y más."
    },
    card3: {
      title: "Spice Tour",
      text: "Visite plantaciones de especias, deguste y descubra la herencia suajili."
    }
  },
  booking: {
  ...
  footer: {
    location: "Zanzíbar, Tanzania"
  },
  wa: {
    welcome: "¡Hola MVITA Travels!",
    message: { header: "¡Hola MVITA Travels!" }
  }
}
};

// Fonction d'assistance Lang
getLang(){
const sel = document.getElementById('lang');
if (sel && sel.value) renvoie sel.value ;
const html = document.documentElement;
return html.getAttribute('data-lang') || 'fr';
}
...
// Hook language selector if exists
const sel = document.getElementById('lang');
if (sel){
  // Try to set initial value from html[data-lang]
  const htmlLang = document.documentElement.getAttribute('data-lang');
  if (htmlLang) sel.value = htmlLang;
